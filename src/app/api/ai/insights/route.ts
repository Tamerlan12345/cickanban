...
export async function POST(request: Request) {
  try {
    ...
    try {
      ...
      const prompt = `
Вы — опытный Agile Scrum-коуч и PM. Проанализируйте список всех текущих задач проекта в страховой компании:
...
`;
      ...
      return NextResponse.json({
        ...
        recommendations: [
          ...
          "Проведите оценку сложности (Story Points) для более точного планирования спринтов.",
    ...
    console.error('AI Insights API root error:', error);
    return NextResponse.json(
